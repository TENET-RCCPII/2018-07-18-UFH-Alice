...
venue: "University of Fort Hare - Alice Campus"        # brief name of host site without address (e.g., "Euphoric State University")
address: "ENGEN Lab, Libraries, University of Fort Hare, Alice Campus"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-32.7891356,26.7897755"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "12 - 14 November, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2018-11-14        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Danielle Quin", "Gabriel Salubi", "Zak van Heerden"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Kemi Megbowon","TBC"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: http://pad.software-carpentry.org/2018-11-12-UFH-Alice            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
